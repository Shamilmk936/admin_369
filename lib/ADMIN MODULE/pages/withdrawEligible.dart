...
class WithdrawEligiblePage extends StatelessWidget {
  const WithdrawEligiblePage({Key? key}) : super(key: key);
          ...
          SingleChildScrollView(
            ...
            child: DataTable(
                ...
                columns: [
                  ...
                  const DataColumn(label: Text('Acc Number')),
                  const DataColumn(label: Text('Acc Name')),
                  const DataColumn(label: Text('IFSC')),
                  const DataColumn(label: Text('Branch')),
                  const DataColumn(label: Text('Bank')),
                  const DataColumn(label: Text('Request To')),
                  const DataColumn(label: Text('Withdraw Request To')),
                  const DataColumn(label: Text('Amount')),
                  const DataColumn(label: Text('Action')),
                  const DataColumn(label: Text('View User')),
                ],
                rows: [
                  DataRow(cells: [
