        ...
        body: Padding(
          ...
          Row(
            children: const [
              ...
              SizedBox(width: 10),
              Text('Advanced table',style: TextStyle(fontSize: 20,color: Colors.grey),)
            ],
          ),
                ...
                child: FittedBox(
                  child: DataTable(
                      ...
                      columns: [
                        ...
                        const DataColumn(label: Expanded(child: Text('Join Date'))),
                      ...
                      rows: [
                        ...
                        //   DataCell(Text('250')),
                        //   DataCell(Text('250')),
                        //   DataCell(Text('Activate')),
                        //   DataCell(Text('GC1231123')),
                        //   DataCell(Text('View')),
                        // ]),
                        // DataRow(cells: [
                        //   DataCell(Text('3')),
