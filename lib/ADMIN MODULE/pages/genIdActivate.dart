...
class GenIdActivatePage extends StatelessWidget {
          ...
          Expanded(
            child: FittedBox(
              child: DataTable(
                    ...
                    rows: [
                      DataRow(cells: [
                        const DataCell(Expanded(flex: 1,
                            child: Text('1'))),
                        const DataCell(Expanded(flex:1,child: Text('GCR168783'))),
                        const DataCell(Expanded(flex:1,child: Text('17-07-2022'))),
                        const DataCell(Expanded(flex:1,child: Text('0'))),
                        const DataCell(Expanded(flex:1,child: Text('250'))),
                        const DataCell(Expanded(flex:1,child: Text('Activate'))),
                        DataCell(Container(
                            height: 30,
                            width: 90,
                            decoration: BoxDecoration(
