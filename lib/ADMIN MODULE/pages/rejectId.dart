...
class RejectIdPage extends StatelessWidget {
  const RejectIdPage({Key? key}) : super(key: key);
                ...
                child: FittedBox(
                  child: DataTable(
                      ...
                      columns: [
                        ...
                        const DataColumn(label: Text('Reject Count')),
                      ...
                      rows: [
                        DataRow(cells: [
                          ...
                          const DataCell(Text('Rebirth ID')),
                          DataCell(Container(
                              height: 30,
                              width: 90,
                              decoration: BoxDecoration(
