...
class PlanReportPage extends StatelessWidget {
  const PlanReportPage({Key? key}) : super(key: key);
                    ...
                    child: FittedBox(
                      child: DataTable(
                          ...
                          columns: [
                            ...
                            const DataColumn(label: Text('Sponser ID')),
                            const DataColumn(label: Text('Sponser Name')),
                            const DataColumn(label: Text('Referrals')),
                            const DataColumn(label: Text('Board')),
                            const DataColumn(label: Text('Club')),
                            const DataColumn(label: Text('Toatal Income')),
                            const DataColumn(label: Text('Wallet')),
                            const DataColumn(label: Text('Plan Income')),
                            const DataColumn(label: Text('Goto Panel')),
